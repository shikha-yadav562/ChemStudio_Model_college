...
class Group6CTMgScreen extends StatefulWidget {
  const Group6CTMgScreen({super.key});

  @override
  State<Group6CTMgScreen> createState() => _Group6CTMgScreenState();
}

class _Group6CTMgScreenState extends State<Group6CTMgScreen>
