...
class WetTestBGroupZeroCTScreen extends StatefulWidget {
  const WetTestBGroupZeroCTScreen({super.key});

  @override
  State<WetTestBGroupZeroCTScreen> createState() =>
      _WetTestBGroupZeroCTScreenState();
}
