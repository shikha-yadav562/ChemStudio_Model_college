...
class WetTestBGroupTwoDetectionScreen extends StatefulWidget {
  const WetTestBGroupTwoDetectionScreen({super.key});

  @override
  State<WetTestBGroupTwoDetectionScreen> createState() =>
      _WetTestBGroupTwoDetectionScreenState();
}

class _WetTestBGroupTwoDetectionScreenState
    extends State<WetTestBGroupTwoDetectionScreen>
  ...
  late final List<WetTestItem> _tests = [
    WetTestItem(
      ...
      procedure: 'O.S/Filtrate + Dil. HCl + H₂S gas / water',
  ...
  void _next() async {
    if (_selectedOption == 'Group-II is present') {
      await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => const WetTestBGroupTwoAnalysisScreen(),
        ),
      );
