...
class WetTestBGroupTwoAnalysisScreen extends StatefulWidget {
  const WetTestBGroupTwoAnalysisScreen({super.key});

  @override
  State<WetTestBGroupTwoAnalysisScreen> createState() =>
      _WetTestBGroupTwoAnalysisScreenState();
}

class _WetTestBGroupTwoAnalysisScreenState
    extends State<WetTestBGroupTwoAnalysisScreen>
  ...
  void _next() {
    ...
    if (_selectedOption == 'Cu²⁺ may be present') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const WetTestBGroupTwoCTCuScreen()),
      );
    } else if (_selectedOption == 'As³⁺ may be present') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const WetTestBGroupTwoCTAsScreen()),
      );
    }
  }

  void _prev() {
    // Navigate back to the Group II Detection screen (WetTestBGroupOneDetectionScreen)
