...
class WetTestAGroupFourDetectionScreen extends StatelessWidget {
  const WetTestAGroupFourDetectionScreen({super.key});
  @override
...
class WetTestAGroupThreeDetectionScreen extends StatefulWidget {
  const WetTestAGroupThreeDetectionScreen({super.key});

  @override
  State<WetTestAGroupThreeDetectionScreen> createState() =>
      _WetTestAGroupThreeDetectionScreenState();
}

class _WetTestAGroupThreeDetectionScreenState
    extends State<WetTestAGroupThreeDetectionScreen>
  ...
  void _next() async {
    if (_selectedOption == 'Group-III is present') {
      await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => const WetTestAGroupThreeAnalysisScreen(),
        ),
      );
