...
class saltANi2ConfirmedPage extends StatefulWidget {
  const saltANi2ConfirmedPage({super.key});

  @override
  State<saltANi2ConfirmedPage> createState() => _saltANi2ConfirmedPageState();
}

class _saltANi2ConfirmedPageState extends State<saltANi2ConfirmedPage>
  ...
  final WetTestItem _test = WetTestItem(
    ...
    options: ['Ni²⁺ confirmed'],
    correct: 'Ni²⁺ confirmed',
  );
