...
class saltAGroup4AnalysisScreen extends StatefulWidget {
  ...
  void _next() async {
    if (_selectedOption == 'Ni²⁺ may be present') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltANi2ConfirmedPage()),
      );
    } else if (_selectedOption == 'Co²⁺ may be present') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltACo2ConfirmedPage()),
      );
    } else if (_selectedOption == 'Mn²⁺ may be present') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltAMn2ConfirmedPage()),
      );
    } else if (_selectedOption == 'Zn²⁺ may be present') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltAZn2ConfirmedPage()),
      );
    }
  }
