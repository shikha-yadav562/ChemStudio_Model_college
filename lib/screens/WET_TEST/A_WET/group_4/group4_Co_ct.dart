...
class saltACo2ConfirmedPage extends StatefulWidget {
  const saltACo2ConfirmedPage({super.key});

  @override
  State<saltACo2ConfirmedPage> createState() => _saltACo2ConfirmedPageState();
}

class _saltACo2ConfirmedPageState extends State<saltACo2ConfirmedPage>
  ...
  final WetTestItem _test = WetTestItem(
    ...
    options: ['Co²⁺ confirmed'],
    correct: 'Co²⁺ confirmed',
  );
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              '(conc. HCl + conc. HNO₃ in 3:1 proportion) dilute with water. '
