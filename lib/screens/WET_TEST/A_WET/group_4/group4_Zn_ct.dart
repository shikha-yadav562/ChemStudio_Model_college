...
class saltAZn2ConfirmedPage extends StatefulWidget {
  const saltAZn2ConfirmedPage({super.key});

  @override
  State<saltAZn2ConfirmedPage> createState() => _saltAZn2ConfirmedPageState();
}

class _saltAZn2ConfirmedPageState extends State<saltAZn2ConfirmedPage>
