...
class saltAMn2ConfirmedPage extends StatefulWidget {
  const saltAMn2ConfirmedPage({super.key});

  @override
  State<saltAMn2ConfirmedPage> createState() => _saltAMn2ConfirmedPageState();
}

class _saltAMn2ConfirmedPageState extends State<saltAMn2ConfirmedPage>
