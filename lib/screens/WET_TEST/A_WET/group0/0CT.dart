...
import 'package:chemstudio/screens/WET_TEST/A_WET/group1/group1detection.dart';
...
class WetTestAGroupZeroCTScreen extends StatefulWidget {
  ...
  @override
  State<WetTestAGroupZeroCTScreen> createState() =>
      _WetTestAGroupZeroCTScreenState();
}
  ...
  Future<void> _handleNext() async {
    ...
    if (presentCount >= 2) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const WetTestAGroupOneDetectionScreen(),
        ),
      );
    }
  }
