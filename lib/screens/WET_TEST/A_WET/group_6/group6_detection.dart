...
class saltAGroup6Detection extends StatefulWidget {
  const saltAGroup6Detection({super.key});

  @override
  State<saltAGroup6Detection> createState() => _saltAGroup6DetectionState();
}

class _saltAGroup6DetectionState extends State<saltAGroup6Detection>
  ...
  void _next() async {
    if (_selectedOption == 'Group-VI is present') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltAGroup6AnalysisScreen()),
      );
