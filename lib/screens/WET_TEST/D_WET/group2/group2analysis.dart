...
class _WetTestDGroupTwoAnalysisScreenState
    extends State<WetTestDGroupTwoAnalysisScreen>
  ...
  void _next() {
    ...
    if (_selectedOption == 'Cu²⁺ may be present') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const WetTestDGroupTwoCTCuScreen()),
      );
    } else if (_selectedOption == 'As³⁺ may be present') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const WetTestDGroupTwoCTAsScreen()),
      );
    }
  }
