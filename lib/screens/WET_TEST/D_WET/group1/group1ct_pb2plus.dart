...
class WetTestDGroupOneCTScreen extends StatefulWidget {
  const WetTestDGroupOneCTScreen({super.key});

  @override
  State<WetTestDGroupOneCTScreen> createState() =>
      _WetTestDGroupOneCTScreenState();
}

class _WetTestDGroupOneCTScreenState extends State<WetTestDGroupOneCTScreen>
  ...
  Future<void> _handleNext() async {
    ...
    final studentGroups = await _dbHelper.getStudentGroupDecisions('D');
